...
from objetivos import objetivo_ronda
from puntaje import jugarMano
from cartas import recargarMazo, MAX_SELECCION
from jokers import obtenerListaJokers
...
MUSIC_GAME = os.path.join(BASE_DIR, "musica_juego.mp3")   
MUSIC_SHOP = os.path.join(BASE_DIR, "musica_shop.mp3")    
...
def main():
    current_state: BaseState = MenuState("fondo.jpg")
